import datetime
from sqlalchemy import Column, Integer, String, BigInteger, ForeignKey, Date, Text, Boolean
...
class BoughtGoods(Database.BASE):
    ...
    bought_datetime = Column(Date, nullable=False)
...
class Operations(Database.BASE):
    ...
    operation_time = Column(Date, nullable=False)
